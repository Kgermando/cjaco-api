    ...
    constructor(private configService: ConfigService) {
      ...
      async sendForgotPasswordEmail(user: User, resetToken: string): Promise<void> {
        ...
        const sendMailDto: SendMailDto = {
          ...
          message: `<p>Hey ${user.fullname}!</p> <p>You can reset your password by visiting this link: <a href="${url}">${url}</a>.</p> <p>But hurry, because it will expire in 30 minutes.</p>`,
        };
